...
public class DemoLeatherarmour extends EnhancedMapTile{
    private int damage; // need to instantiate and make getters/setters
    private String description;

    public DemoLeatherarmour(Point location) {
    ...
    protected GameObject loadBottomLayer(SpriteSheet spriteSheet) {
        Frame frame = new FrameBuilder(spriteSheet.getSubImage(6, 7, false))
                .build();
