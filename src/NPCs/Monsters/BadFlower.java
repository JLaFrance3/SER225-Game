...
public class BadFlower extends NPC {
    ...
    public BadFlower(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(
                ImageLoader.load("BadFlower.png"),
                95, 120), "STAND_UP");
        this.health = health;
        ...
        return new HashMap<String, Frame[]>() {{
           ...
           put("STAND_UP", new Frame[] {
            ...
            new FrameBuilder(spriteSheet.getSprite(2, 1, false))
                     ...
                     .withScale(1)
                     .build(),
            new FrameBuilder(spriteSheet.getSprite(2, 2, false))
                     .withBounds(24, 26, 16, 32)
                     .withScale(1)
                     .build(),
            new FrameBuilder(spriteSheet.getSprite(2, 3, false))
                     .withBounds(24, 26, 16, 32)
                     .withScale(1)
                     .build(),
            new FrameBuilder(spriteSheet.getSprite(2, 4, false))
                     .withBounds(24, 26, 16, 32)
                     .withScale(1)
                     .build(),
            new FrameBuilder(spriteSheet.getSprite(2, 5, false))
                     .withBounds(24, 26, 16, 32)
                     .withScale(1)
                     .build(),
            });
            ...
            put("WALK_LEFT", new Frame[] {
                    new FrameBuilder(spriteSheet.getSprite(1, 0, false), 20)
                            .withBounds(24, 26, 16, 32)
                            .withScale(1)
                            .build(),
                    new FrameBuilder(spriteSheet.getSprite(1, 1, false), 20)
                            .withBounds(24, 26, 16, 32)
                            .withScale(1)
                            .build(),
                    new FrameBuilder(spriteSheet.getSprite(1, 2, false), 20)
                            .withBounds(24, 26, 16, 32)
                            .withScale(1)
                            .build(),
                    new FrameBuilder(spriteSheet.getSprite(1, 3, false), 20)
                            .withBounds(24, 26, 16, 32)
                            .withScale(1)
                            .build(),
                    new FrameBuilder(spriteSheet.getSprite(1, 4, false), 20)
                            .withBounds(24, 26, 16, 32)
                            .withScale(1)
                            .build(),
                    new FrameBuilder(spriteSheet.getSprite(1, 5, false), 20)
                            .withBounds(24, 26, 16, 32)
                            .withScale(1)
                            .build(),
            });
            ...
            put("WALK_RIGHT", new Frame[] {
                new FrameBuilder(spriteSheet.getSprite(3, 0, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(3, 1, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(3, 2, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(3, 3, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(3, 4, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(3, 5, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
            });
            put("WALK_UP", new Frame[] {
                new FrameBuilder(spriteSheet.getSprite(0, 1, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(0, 1, false), 20)
                        ...
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(0, 2, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(3)
                        .build(),
            });
            put("WALK_DOWN", new Frame[] {
                new FrameBuilder(spriteSheet.getSprite(2, 0, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(2, 1, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
                new FrameBuilder(spriteSheet.getSprite(2, 2, false), 20)
                        .withBounds(24, 26, 16, 32)
                        .withScale(1)
                        .build(),
            });
